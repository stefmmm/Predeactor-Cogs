def pintro():
    intro = [
        ...
        "https://github.com/Predeactor/Predeactor-Cogs) if you want to help me in writing this little guide *if* you "
        "already know Python.\n```I want to test my code in Discord!```\nThis is a possible thing if the bot your "
        "talking with is your. [This bot is an instance of Red, an open source Python bot]("
        "https://github.com/Cog-Creators/Red-DiscordBot), if the bot is not your, you can follow the link to host a "
        "bot at your own (Don't worry, it's easy to setup and use :3). When starting up your bot, you can parse the "
        "`--dev` argument, but if you use the mock cog, you can install the cog `dev` from [TrustyJAID's repo]("
...
def pref():
    ref = [
        ...
        "programming:```\n[Learn X in Y minutes, Where X=Python](https://learnxinyminutes.com/docs/python3/) (For who "
...
def plvl2():
    lvl2_list = [
        ...
        "books of history the from your books of physics, then you use 2 box, a `History` box, where there's all of "
        "your history books, and another one box called `Science` where there's every science books. (Explaining made "
...
def plvl3():
    ...
    lvl3_list = [
        ...
        f"awesome'`, `\"I love strings!\"`\n\n:warning: **If you want to use a double quote into a string who's using "
        ...
        f"there's 2 types of booleans, `True` and `False`, those are VERY important AND, please, keep them somewhere "
        f"in your mind.",
        30,
